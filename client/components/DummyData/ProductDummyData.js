...
// https://app-hrsei-api.herokuapp.com/api/fec2/hratx/products/24156
var productInfo = {
  id: 24156,
  campus: 'hratx',
  name: 'Camo Onesie',
...
// https://app-hrsei-api.herokuapp.com/api/fec2/hratx/products/24156/styles
var productStyles = {
  product_id: '24156',
  results: [
    {
      ...
      skus: {
        789840: { quantity: 8, size: 'XS' },
        789841: { quantity: 16, size: 'S' },
        789842: { quantity: 17, size: 'M' },
        789843: { quantity: 10, size: 'L' },
        789844: { quantity: 15, size: 'XL' },
        789845: { quantity: 4, size: 'XL' },
      },
    },
    {
      style_id: 136242,
      ...
      skus: {
        789846: { quantity: 8, size: 'XS' },
        789847: { quantity: 16, size: 'S' },
        789848: { quantity: 17, size: 'M' },
        789849: { quantity: 10, size: 'L' },
        789850: { quantity: 15, size: 'XL' },
        789851: { quantity: 6, size: 'XXL' },
      },
    },
    {
      style_id: 136243,
      ...
      skus: {
        789852: { quantity: 8, size: 'XS' },
        789853: { quantity: 16, size: 'S' },
        789854: { quantity: 17, size: 'M' },
        789855: { quantity: 10, size: 'L' },
        789856: { quantity: 15, size: 'XL' },
        789857: { quantity: 6, size: 'XXL' },
      },
    },
    {
      style_id: 136244,
      ...
      skus: {
        789858: { quantity: 8, size: 'XS' },
        789859: { quantity: 16, size: 'S' },
        789860: { quantity: 17, size: 'M' },
        789861: { quantity: 10, size: 'L' },
        789862: { quantity: 15, size: 'XL' },
        789863: { quantity: 6, size: 'XXL' },
      },
    },
    {
      style_id: 136245,
      ...
      skus: {
        789864: { quantity: 8, size: 'XS' },
        789865: { quantity: 16, size: 'S' },
        789866: { quantity: 17, size: 'M' },
        789867: { quantity: 10, size: 'L' },
        789868: { quantity: 15, size: 'XL' },
        789869: { quantity: 6, size: 'XXL' },
      },
    },
    {
      style_id: 136246,
      ...
      skus: {
        789870: { quantity: 8, size: 'XS' },
        789871: { quantity: 16, size: 'S' },
        789872: { quantity: 17, size: 'M' },
        789873: { quantity: 10, size: 'L' },
        789874: { quantity: 15, size: 'XL' },
        789875: { quantity: 6, size: 'XXL' },
      },
    },
  ],
};
...
// https://app-hrsei-api.herokuapp.com/api/fec2/hratx/products/24156/related
var relatedProducts = [24157, 24158, 24163, 24162];
